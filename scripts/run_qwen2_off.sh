...
#SBATCH -o log/GRPO-epoch.out
#SBATCH -e log/error-epoch.out
#SBATCH --mem=192G
#SBATCH --time=1-00:00:00
#SBATCH --job-name=grpo-epoch-mu
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.ppo_epochs=$mu\
    ...
    trainer.experiment_name=${model_name}-${dataset}-GRPO-adamw-mu${mu} \
